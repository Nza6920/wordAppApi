...
public class SetCurrentTest extends RestfulApi {
    @Override
    public Object execute(JSONObject jreq) throws Exception {
        // 请求参数不正确, 返回403
        if (!ServiceUtils.jsonVerify(jreq, new String[]{"currentTest"})) {
        ...
        try {
            ...
            optionDao.setCurrentTest(jreq.getInt("userId"), jreq.getInt("currentTest"));
        } finally {
